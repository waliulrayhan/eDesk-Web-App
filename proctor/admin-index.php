...
$query = "SELECT * FROM post WHERE status='Approved' AND user_id != '0' and (office_id='13' or office_id='21') ORDER BY date_time DESC LIMIT 50";
        ...
        <?php while ($post = mysqli_fetch_assoc($posts)): ?>
            <article class="post">
                ...
                <div class="post__info">
                    ...
                    <a href="<?= ROOT_URL ?>proctor/admin-catagory-post.php?id=<?= $post['office_id'] ?>"
                    ...
                    <p class="post__body">
                        ...
                        <div class="post__author">
                            <div class="post__author-info">
                                ...
                                <?php else: ?>
                                    <h5><a href="<?= ROOT_URL ?>proctor/details-post.php?id=<?= $post['id'] ?>">Add Comment or
                                            Reply</a></h5>
                                <?php endif ?>
                            </div>
                        </div>
                ...
                <?php else: ?>
                    ...
                    <div class="post__author">
                        <div class="post__author-info">
                            ...
                            <?php else: ?>
                                <h5><a href="<?= ROOT_URL ?>proctor/details-post.php?id=<?= $post['id'] ?>">Add Comment or Reply</a>
                                </h5>
                            <?php endif ?>
                        </div>
                    </div>

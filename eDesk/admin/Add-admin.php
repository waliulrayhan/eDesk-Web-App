...
$query = "SELECT * FROM usermanagement WHERE stat='active'";
                ...
                <tbody>
                    <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                        <tr>
                            ...
                            <td><?= $user['email'] ?></td>
                            <!-- <td><?= $user['stat'] ?></td> -->
                            <td align="center"><?= $user['admin-status'] ?></td>
                            <td align="center"><a href="<?= ROOT_URL ?>admin/active-user-logic.php?id=<?= $user['id'] ?>" class="btn sm">YES</a> <a href="<?= ROOT_URL ?>admin/deactive-user-logic.php?id=<?= $user['id'] ?>" class="btn sm">NO</a></td>
                        </tr>
                    <?php endwhile ?>
                </tbody>
            </table>

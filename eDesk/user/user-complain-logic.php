...
if (isset($_POST['submit'])) {
    ...
    if (isset($_SESSION['user-complain'])) {
        ...
        $query = "INSERT INTO post (title, body, picture, office_id, user_id, type) VALUES ('$title', '$body', '$picture_name', '$category_id', '$author_id', 'Complain: C-')";
        $result = mysqli_query($connection, $query);

        if (!mysqli_errno($connection)) {
            $_SESSION['user-complain-success'] = "New complain post added successfully";

...
$query = "SELECT id, title, office_id, body, status, type, post_type FROM post WHERE user_id != 0 and (office_id='13' or office_id='21') and status='Pending' ORDER BY status DESC;";
                ...
                <tbody>
                    <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                        ...
                        <tr>
                            ...
                            <td align="center"><a href="<?= ROOT_URL ?>proctor/admin-manage-users-post-active.php?id=<?= $post['id'] ?>" class="btn sm">Approve</a> <a href="<?= ROOT_URL ?>proctor/delete-post-user.php?id=<?= $post['id'] ?>" class="btn sm danger">Delete</a></td>
                        </tr>
                    <?php endwhile ?>
                </tbody>
            </table>
